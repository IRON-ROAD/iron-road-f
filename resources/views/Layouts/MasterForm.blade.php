...
<head>
    ...
    <!-- Bracket CSS -->
    <link rel="stylesheet" href="css/sisi.css">

    <script>
        function issued_ticket(){
            alert('test test');
        }
    </script>
</head>
...
<div class="br-mainpanel">
    ...
    <footer class="br-footer">
        <div class="footer-left">
            <div class="mg-b-2">Copyright &copy; {{date('Y')}}.TRC Revenue System. All Rights Reserved.</div>
            <div>Made by RI Mollel</div>
        </div>
...
<script type="text/javascript" src="js/ticket_calculator.js"></script>
