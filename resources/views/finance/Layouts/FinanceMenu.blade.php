<div class="br-sideleft overflow-y-auto">
    ...
    <ul class="br-sideleft-menu">
        <li class="br-menu-item">
            <a href="" class="br-menu-link @yield('home_active')">
                <i class="menu-item-icon icon ion-ios-home-outline tx-24"></i>
                <span class="menu-item-label">Dashboard</span>
            </a><!-- br-menu-link -->
        </li><!-- br-menu-item -->
        <li class="br-menu-item">
            <a href="{{URL::route('voucher_entry')}}" class="br-menu-link @yield('voucher_entry')" >
                <i class="fa fa-ticket tx-24"></i>
                <span class="menu-item-label">Voucher Entry</span>
            </a><!-- br-menu-link -->
        </li><!-- br-menu-item -->
        <li class="br-menu-item">
