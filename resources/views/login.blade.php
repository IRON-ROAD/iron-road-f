...
<div class="row no-gutters flex-row-reverse ht-100v">
    <div class="col-md-6 bg-gray-200 d-flex align-items-center justify-content-center">
        <div class="login-wrapper wd-250 wd-xl-350 mg-y-30">
            ...
            <div class="mg-t-60 tx-center">Copyright &copy; {{date('Y')}} TRC</div>
        </div><!-- login-wrapper -->
    </div><!-- col -->
    <div class="col-md-6 bg-br-primary d-flex align-items-center justify-content-center">
        <div class="wd-250 wd-xl-450 mg-y-30">
            <div class="signin-logo tx-28 tx-bold tx-white"><span class="tx-normal"></span> TRC <span class="tx-info">Finance System</span> <span class="tx-normal"></span></div>
            <div class="tx-white mg-b-60">Together We Move</div>

            <h5 class="tx-white">What is TRC System?</h5>
            ...
            <a href="" class="btn btn-outline-light bd bd-white bd-2 tx-white pd-x-25 tx-uppercase tx-12 tx-spacing-2 tx-medium">Read More</a>
        </div><!-- wd-500 -->
    </div>
</div><!-- row -->
